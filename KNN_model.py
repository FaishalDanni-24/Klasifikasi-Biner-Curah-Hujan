...
def save_model(model):
    ...
    print("Best K Nearest Neighbor Model is saved!")
...
def main():
    ...
    print("Using Algorithm: K Nearest Neighbor")
    ...
    # Feature importance
    show_metric(best_rain_classifier_model)


    # Evaluasi model pada set training
    evaluate_model(best_rain_classifier_model, X_train_sm, y_train_sm, "figures/Model/KNN", "Training Set")

    # Evaluasi model pada set test
    evaluate_model(best_rain_classifier_model, X_test, y_test, "figures/Model/KNN", "Test Set")

    # Simpan model
    save_model( best_rain_classifier_model)
